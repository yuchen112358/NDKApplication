...
#include "io_github_wzzju_ndkapplication_NativeLib.h"
#include <stdio.h>
#include <sys/ioctl.h>
#include <unistd.h>
#include <sys/types.h>
...
JNIEXPORT jstring JNICALL Java_io_github_wzzju_ndkapplication_NativeLib_GetGPUCurFreq
    ...
    fd = open("/storage/sdcard0/GPUFreq.txt", O_WRONLY | O_APPEND | O_CREAT,
...
JNIEXPORT jstring JNICALL Java_io_github_wzzju_ndkapplication_NativeLib_GetCPUCurFreq
    ...
    memset(freq, '\0', 20);
    char fileP[50];
    sprintf(fileP, "/storage/sdcard0/CPU%dFreq.txt", num);
